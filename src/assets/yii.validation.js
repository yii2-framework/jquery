...
yii.validation = (function ($) {
  ...
  function isRequiredValid(value, options) {
    if (options.requiredValue !== undefined) {
      return options.strict
        ...
        : isLooseEqual(value, options.requiredValue);
    }
  ...
  function isBooleanValid(value, options) {
    ...
    return (
      isLooseEqual(value, options.trueValue) ||
      isLooseEqual(value, options.falseValue)
    );
  }
  ...
  function isExpectedStringLength(value, options, messages) {
    if (
      ...
      !isLooseNotEqual(value.length, options.is)
    ) {
      return true;
    }
  ...
  function validateEmailValue(value, options) {
    ...
    var valid =
      ...
      (options.allowName && options.fullPattern.test(normalizedValue));
  ...
  function addImageSizeMessageIfNeeded(
    limit,
    actualSize,
    messageTemplate,
    file,
