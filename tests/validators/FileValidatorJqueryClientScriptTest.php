...
/**
 * Unit tests for {@see FileValidatorJqueryClientScript} jQuery client-side validation script.
 *
...
#[Group('jquery')]
#[Group('validators')]
final class FileValidatorJqueryClientScriptTest extends \yii\jquery\tests\TestCase
{
