...
/**
 * Unit tests for {@see RangeValidatorJqueryClientScript} jQuery client-side validation script.
 *
...
#[Group('jquery')]
#[Group('validators')]
final class RangeValidatorJqueryClientScriptTest extends \yii\jquery\tests\TestCase
{
