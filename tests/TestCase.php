...
/**
 * Base test case for yii2-framework/jquery tests.
 *
 * Provides application lifecycle helpers and assertion utilities. All applications are created via
 * {@see ApplicationFactory}, which bootstraps `yii\jquery\Bootstrap` and configures client-script defaults via the DI
 * container.
 */
abstract class TestCase extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @phpstan-param array<string, mixed> $config Application configuration to merge with the default configuration.
