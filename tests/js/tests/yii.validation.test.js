...
describe("yii.validation", function () {
  ...
  function getValidatorMessage(expectedResult) {
    var isTrueBoolean =
      typeof expectedResult === "boolean" && expectedResult === true;
    var isEmptyArray =
      Array.isArray(expectedResult) && expectedResult.length === 0;

    return isTrueBoolean || isEmptyArray
      ? VALIDATOR_SUCCESS_MESSAGE
    ...
    withData(
      {
        ...
        "string containing whitespace": [" ", {}, false],
        "string containing whitespace, strict mode": [
          " ",
          { strict: true },
          true,
        ],
        ...
        // requiredValue
        "integer and required value set to different integer": [
          1,
          { requiredValue: 2 },
          false,
        ],
        "string and required value set to integer with the same value": [
          "1",
          { requiredValue: 1 },
          true,
        ],
        "string and required value set to integer with the same value, strict mode":
          ["1", { requiredValue: 1, strict: true }, false],
    ...
    withData(
      {
        ...
        "non-empty string, does not equal neither trueValue no falseValue": [
          "a",
          {},
          false,
        ],
    ...
    withData(
      {
        ...
        "string does not equal exact length": [
          "Does not equal",
          { is: 5 },
          ["Not equal."],
        ],
        "string does not equal exact length and less than min": [
          "Word",
          { is: 5, min: 5 },
          ["Not equal."],
        ],
        // min and max
        "string less than min, both min and max are set": [
          "Word",
          { min: 5, max: 10 },
          ["Too short."],
        ],
        "string in between of min and max, both min and max are set": [
          "Between",
          { min: 5, max: 10 },
          [],
        ],
        "string more than max, both min and max are set": [
          "Some string",
          { min: 5, max: 10 },
          ["Too long."],
        ],
      ...
      withData(
        ...
        function (uploadedFiles, customOptions, expectedMessages) {
          it(getValidatorMessage(expectedMessages), function () {
            ...
            assert.deepEqual(jQueryInitStub.getCall(0).args, [
              attribute.input,
              attribute.$form,
            ]);
    ...
    describe("with FileReader API is available", function () {
      it(VALIDATOR_ERROR_MESSAGE, function () {
        ...
        for (var i = 0; i < validateImageStub.callCount; i++) {
          ...
          assert.deepEqual(validateImageStub.getCall(i).args[1], [
            "File file.bmp has wrong extension.",
          ]);
      ...
      withData(
        {
          ...
          "width equals minimum width": [
            { width: 100, height: 100 },
            { minWidth: 100 },
            [],
          ],
          "width more than minimum width": [
          ...
          "height equals minimum height": [
            { width: 100, height: 100 },
            { minHeight: 100 },
            [],
          ],
          "height more than minimum height": [
            { width: 200, height: 200 },
            { minHeight: 100 },
            [],
          ],
          // maxHeight
          "height less than maximum height": [
            { width: 100, height: 100 },
            { maxHeight: 200 },
            [],
          ],
          "height equals maximum height": [
            { width: 100, height: 100 },
            { maxHeight: 100 },
            [],
          ],
      ...
      withData(
        {
          ...
          "wrong integer and less than min": [
            "1.5",
            { min: 2 },
            ["Not a number."],
          ],
  ...
  describe("range validator", function () {
    withData(
      {
        "empty string, skip on empty": ["", { skipOnEmpty: true }, []],
        "array and arrays are not allowed": [
          ["a", "b"],
          {},
          ["Invalid value."],
        ],
        ...
        "string in array and inverted logic": [
          "a",
          { range: ["a", "b", "c"], not: true },
          ["Invalid value."],
        ],
        "string not in array and inverted logic": [
          "d",
          { range: ["a", "b", "c"], not: true },
          [],
        ],
      ...
      withData(
        {
          ...
          "regular integer, inverted logic": [
            "2",
            { not: true },
            ["Invalid value."],
          ],
          "integer pattern, non-integer, inverted logic": [
            "2.5",
            { pattern: integerPattern, not: true },
            [],
          ],
        },
        function (value, options, expectedMessages) {
      ...
      withData(
        {
          ...
          "uppercase and lowercase letters, dot and numbers in local-part": [
            "Abc.123@example.com",
            true,
          ],
          "user mailbox": [
          ...
          "angle brackets, name, unicode in domain": [
            "Information <info@örtliches.de>",
            false,
          ],
          "angle brackets, name, unicode, local-part length is close to 64 characters":
            [
              // 21 * 3 = 63
              "Короткое имя <" +
                StringUtils.repeatString("бла", 21) +
                "@пример.com>",
              false,
            ],
          "angle brackets, name, unicode, domain length is close to 254 characters":
            [
              // 83 * 3 + 4 = 253
              "Короткое имя <тест@" +
                StringUtils.repeatString("бла", 83) +
                ".com>",
              false,
            ],
        },
  ...
  describe("url validator", function () {
    function getPattern(validSchemes) {
      ...
      var pattern =
        "^{schemes}://(([A-Z0-9][A-Z0-9_-]*)(\\.[A-Z0-9][A-Z0-9_-]*)+)(?::\\d{1,5})?(?:$|[?\\/#])";
      ...
      withData(
        {
          ...
          "scheme not in valid schemes": [
            "ftp://ftp.ruhr-uni-bochum.de/",
            false,
          ],
          "invalid domain": ["http://invalid,domain", false],
          "not allowed symbol (comma) after domain": [
            "http://example.com,",
            false,
          ],
          "not allowed symbol (star) after domain": [
            "http://example.com*12",
            false,
          ],
          ...
          "port (length equals limit), anchor": [
            "http://example.com:65535/#test",
            true,
          ],
          "port, get parameter without value": [
            "http://example.com:81/?good",
            true,
          ],
          "get parameter without value and slash": [
            "http://example.com?test",
            true,
          ],
          "anchor without slash": ["http://example.com#test", true],
          "port and anchor without slash": ["http://example.com:81#test", true],
          "port and get parameter without value and slash": [
            "http://example.com:81?good",
            true,
          ],
          "not allowed symbol after domain followed by get parameter without value":
            ["http://example.com,?test", false],
          "skipped port and get parameter without value": [
            "http://example.com:?test",
            false,
          ],
          "skipped port and action": ["http://example.com:test", false],
          "port (length more than limit) and action": [
            "http://example.com:123456/test",
            false,
          ],
  ...
  describe("trim filter", function () {
    ...
    describe("with empty string, skip on empty", function () {
      it("should leave value and element value as is and return not changed value", function () {
        ...
        assert.strictEqual(
          yii.validation.trim($form, attribute, { skipOnEmpty: true }),
          "",
        );
    ...
    withData(
      {
        "empty string, skip on empty": ["", { skipOnEmpty: true }, true],
        // ==
        '"==" operator, 2 identical integers': [
          2,
          { operator: "==", compareValue: 2 },
          true,
        ],
        '"==" operator, 2 different integers': [
          2,
          { operator: "==", compareValue: 3 },
          false,
        ],
        '"==" operator, 2 identical decimal fractions': [
          2.5,
          { operator: "==", compareValue: 2.5 },
          true,
        ],
        '"==" operator, integer and string with the same values': [
          2,
          { operator: "==", compareValue: "2" },
          true,
        ],
        ...
        '"==" operator, 2 identical strings': [
          "b",
          { operator: "==", compareValue: "b" },
          true,
        ],
        // ===
        '"===" operator, 2 identical integers': [
        ...
        '"===" operator, integer and string with the same value': [
          2,
          { operator: "===", compareValue: "2" },
          false,
        ],
        ...
        '">" operator, 2 integers, 2nd is greater': [
          2,
          { operator: ">", compareValue: 3 },
          false,
        ],
        '">" operator, 2 integers, 2nd is lower': [
          2,
          { operator: ">", compareValue: 1 },
          true,
        ],
        '">" operator, 2 identical strings': [
          "b",
        ...
        '">" operator, 2 strings, 2nd is greater': [
          "a",
          { operator: ">", compareValue: "b" },
          false,
        ],
        '">" operator, 2 strings, 2nd is lower': [
          "b",
          { operator: ">", compareValue: "a" },
          true,
        ],
        // >=
        '">=" operator, 2 identical integers': [
        ...
        'default compare value, "===" operator, against undefined': [
          undefined,
          { operator: "===" },
          true,
        ],
    ...
    describe('with compareAttribute, "==" operator and 2 identical strings', function () {
      it(VALIDATOR_SUCCESS_MESSAGE, function () {
        ...
        yii.validation.compare(
          "b",
          messages,
          { operator: "==", compareAttribute: "input-id" },
          $form,
        );
        assert.deepEqual(messages, []);
  ...
  describe("ip validator", function () {
    ...
    var ipv4Pattern =
      "^(?:(?:2(?:[0-4][0-9]|5[0-5])|[0-1]?[0-9]?[0-9])\\.){3}(?:(?:2([0-4][0-9]|5[0-5])|[0-1]?" +
      "[0-9]?[0-9]))$";
    var ipv6Pattern =
    ...
    withData(
      {
        ...
        "not IP, IPv4 is disabled": [
          "not:IP",
          { ipv4: false },
          ["Invalid value."],
        ],
        "not IP, IPv6 is disabled": [
          "not IP",
          { ipv6: false },
          ["Invalid value."],
        ],
        ...
        'IPv4, subnet option is set to "false"': [
          "192.168.10.0",
          { subnet: false },
          [],
        ],
        'IPv4, subnet option is set to "true"': [
          "192.168.10.0",
          { subnet: true },
          ["No subnet."],
        ],
        "IPv4 with CIDR subnet, subnet option is not defined": [
          "192.168.10.0/24",
          {},
          [],
        ],
        ...
        'IPv4 with CIDR subnet, subnet option is set to "true"': [
          "192.168.10.0/24",
          { subnet: true },
          [],
        ],
        // subnet, IPv6
        "IPv6, subnet option is not defined": [
          "2001:0db8:11a3:09d7:1f34:8a2e:07a0:765d",
          {},
          [],
        ],
        'IPv6, subnet option is set to "false"': [
          "2001:0db8:11a3:09d7:1f34:8a2e:07a0:765d",
          { subnet: false },
          [],
        ],
        ...
        'IPv4, negation option is set to "false"': [
          "192.168.10.0",
          { negation: false },
          [],
        ],
        'IPv4, negation option is set to "true"': [
          "192.168.10.0",
          { negation: true },
          [],
        ],
        "IPv4 with negation, negation option is not defined": [
          "!192.168.10.0",
          {},
          [],
        ],
        ...
        'IPv4 with negation, negation option is set to "true"': [
          "!192.168.10.0",
          { negation: true },
          [],
        ],
        // negation, IPv6
        "IPv6, negation option is not defined": [
          "2001:0db8:11a3:09d7:1f34:8a2e:07a0:765d",
          {},
          [],
        ],
        ...
        'IPv6, negation option is set to "true"': [
          "2001:0db8:11a3:09d7:1f34:8a2e:07a0:765d",
          { negation: true },
          [],
        ],
        "IPv6 with negation, negation option is not defined": [
          "!2001:0db8:11a3:09d7:1f34:8a2e:07a0:765d",
          {},
          [],
        ],
        ...
        // ipv4, ipv6
        'IPv4, IPv4 option is set to "false"': [
          "192.168.10.0",
          { ipv4: false },
          ["IPv4 is not allowed."],
        ],
